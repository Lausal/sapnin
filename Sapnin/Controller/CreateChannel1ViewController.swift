...
class CreateChannel1ViewController: UIViewController {
    ...
    func setupTableView() {
        ...
        let arciformFont = UIFont(name: "Arciform", size: 18)!
        searchBarTextField?.font = arciformFont
    }
...
extension CreateChannel1ViewController: UITableViewDelegate, UITableViewDataSource {
...
extension CreateChannel1ViewController: UISearchBarDelegate {
